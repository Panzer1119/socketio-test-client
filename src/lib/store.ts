...
export const serverSettings: Writable<{address:string|null,namespace:string|null, status: ConnectionStatus,options: Record<string,any>, id?:string}> = writable({address:null,namespace:null,status: 'disconnected', options: {}});
